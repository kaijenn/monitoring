                                ...
                                <form action="<?= base_url('home/aksi_e_profile')?>" method="POST">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" id="username" class="form-control" name="username" value="<?= esc($darren->username) ?>" readonly>
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label for="email">Status</label>
                                            <input type="text" id="email" class="form-control" name="email" value="<?= esc($darren->status) ?>" readonly>
                                        </div>
                                        <div class="form-group col-md-12 offset-md-4 mt-4">
    <a href="<?= base_url('home/logout') ?>" class="btn btn-lg btn-danger">
